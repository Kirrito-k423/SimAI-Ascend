...
| D-09 | 10T-scale Workload Schema 与逐 tensor counter throwaway prototype | `prototype/target-10t-workload-contract` 分支 + workload schema 原型票 | READY_FOR_HITL | `8195c3c`；run C005；一命令 TUI；7/7 场景；官方 145,116 tensors 全量对账；待用户 HITL |
