...
| D-10 | 2048-EP AlltoAll 聚合 seam throwaway prototype | `prototype/hierarchical-a2a-projection` 分支 + AlltoAll seam 原型票 | READY_FOR_HITL | `691346f`；run C006；四场景六项守恒 4/4；P=4 Upstream probe；待用户 HITL |
