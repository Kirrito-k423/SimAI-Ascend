...
| D-08 | Ascend Provider seam throwaway logic prototype | `prototype/ascend-provider-seam` 分支 + Provider seam 原型票 | READY_FOR_HITL | run C004；一命令 TUI 6/6 场景通过；Analytical 链接与 Simulation 核心编译通过；待用户评判 |
