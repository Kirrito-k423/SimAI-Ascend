...
| D-09 | 10T-scale Workload Schema 与逐 tensor counter throwaway prototype | `prototype/target-10t-workload-contract` 分支 + workload schema 原型票 | WIP | run C005；待一命令 TUI、官方 baseline/目标/反例场景与用户 HITL |
