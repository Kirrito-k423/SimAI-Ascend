...
| AC-05 | 100k 拓扑、A5 估算、Top-5 搜索与 goodput 决策关闭 | IN_PROGRESS | A5 估算由 C008/ADR-0009 关闭；100k topology/placement 由 C009/ADR-0010 关闭；Top-5 多保真搜索由 C010/ADR-0011 关闭；仅 goodput 待后续票据 | 2026-08-13 |
